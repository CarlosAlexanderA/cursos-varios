          ...
          addedPhotos.map(link => (
            <div key={link} className="relative">
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-white bg-black/50 rounded-full p-2">
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-white bg-black/50 rounded-full p-2">
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
